...
export class FeatureMigrator {
    ...
    private static async runSingleMigration(migration: MigrationFeature, forceAll = false): Promise<void> {
        ...
        const metaDir = path.join(configManager.getStorage().processedDir, 'recents', 'meta');
        ...
        for (const metaFile of metadataFiles) {
            try {
                ...
                const originalPath = path.join(configManager.getStorage().sourceDir, 'recents', originalFilename);
