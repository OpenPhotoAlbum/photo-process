...
const config: Config = {
  title: 'Photo Management Platform',
  tagline: 'Self-hosted photo management with AI-powered face recognition and smart organization',
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Photo Management Platform. Built with Docusaurus.`,
    },
    prism: {
